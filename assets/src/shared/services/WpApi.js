...
WpApi.myPosts = WpApi.registerRoute('c9importer/v1', '/author/(?P<id>)');

WpApi.getCsv = WpApi.registerRoute('c9importer/v1', '/getcsv');

WpApi.importPosts = WpApi.registerRoute('c9importer/v1', '/import-posts');
